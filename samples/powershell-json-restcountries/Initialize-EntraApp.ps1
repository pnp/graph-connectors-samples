...
$app = New-MgApplication -DisplayName "REST Countries - connector (PowerShell)" -RequiredResourceAccess $requiredResourceAccess
...
Set-Secret -Name "restcountriespowershell" -Secret $credential
...
SecretText           : LVK8Q~R63Esx8Ei4hvcwCZNxcquy-g5EElEc7c1B
